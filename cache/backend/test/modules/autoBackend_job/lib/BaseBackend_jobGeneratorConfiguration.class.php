 ...
 */
abstract class BaseBackend_jobGeneratorConfiguration extends sfModelGeneratorConfiguration
{
  ...
  {
    return array(  'deleteNeverActivated' =>   array(    'label' => 'Delete Never Activate Jobs',  ),);
  }
